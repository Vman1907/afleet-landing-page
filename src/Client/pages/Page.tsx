...
const Page: React.FC<PageProps> = ({ loginMetadata, loginfunction, setShowNoProgram, setLeaderboard, setTimeline, }) => {

  const { name } = useParams<{ name: string; }>();
  console.log("page", loginMetadata.package_leaderboard, loginMetadata.package_timeline)
  if (name == "userdashboard") {
    return (
      <ClientDashboard name="userDashboard" loginMetadata={loginMetadata} loginfunction={loginfunction} setShowNoProgram={setShowNoProgram}
  ...
  // }
    ...
    return (
      <ClientCampaign name="ClientCampaign" loginMetadata={loginMetadata} loginfunction={loginfunction} />
    );
  }
  else if (name == "userrewards") {
    return (
      <ClientRewards name="ClientRewards" loginMetadata={loginMetadata} loginfunction={loginfunction} />
    );
  }
    ...
    return (
      <ClientTimeline name="Timeline" loginMetadata={loginMetadata} loginfunction={loginfunction} />
    );
  }
    ...
    return (
      <ClientManage name="Manage" loginMetadata={loginMetadata} loginfunction={loginfunction} />
    );
  }
  else if (name == "userrecruit") {
    return (

      <ClientRecruit name="Recruit" loginMetadata={loginMetadata} loginfunction={loginfunction} />
    );
  }
  else if (name == "afleetdocs") {
    return (
      <ClientResources name="Resources" loginMetadata={loginMetadata} loginfunction={loginfunction} />
    );
  }
  else if (name == "useraccountsetting") {
    return (
      <ClientAccountSetting name="AccountSetting" loginMetadata={loginMetadata} loginfunction={loginfunction} />
    );
  }
  else if (name == "userprofilesetting") {
    return (
      <ClientProfileSetting loginMetadata={loginMetadata} loginfunction={loginfunction} />
    );
  }
  else if (name == "userresources") {
    return (
      <ResourceManagement loginMetadata={loginMetadata} loginfunction={loginfunction} name={'Resource Management'} />
    );
  }
