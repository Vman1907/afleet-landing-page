...
const ClientMediaSetting: React.FC<ClientDashboardProps> = ({
  name,
  loginMetadata,
  loginfunction,
  setShowNoProgram,
  ...
  */
  ...
  useEffect(() => {
    document.title = "User Media Setting - Afleet"
    // setIsLoading(true);
                    ...
                    <IonCardContent>
                      ...
                      <IonRow>
                        ...
                        <IonCol style={{ display: "block", margin: "auto" }}>
                          <IonRow><IonCol class="ion-text-end">Archive Campaign</IonCol></IonRow>
...
export default ClientMediaSetting;
